...
import { Row, Col, Card, Button, Input, Typography, Space, Tag, Drawer, Form, Select, Radio, InputNumber, Alert, Collapse, Tooltip, Modal, Table } from 'antd'
...
import AutoLaunchCard from './AutoLaunchCard'
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <div style={{ maxWidth: wrapperMaxWidth, margin: '0 auto', width: '100%' }}>
        {/* 自动开服卡片：对照真实控制台 DisplayInfoCard 实现，支持普通/AI 两种形态 */}
        <AutoLaunchCard />
